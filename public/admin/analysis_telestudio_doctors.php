...
$db = db();
$rows = $db->query('SELECT doctor_id, full_name, mobile_no, created_at FROM telestudio_doctors ORDER BY created_at DESC')->fetch_all(MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Telestudio Doctors - Admin</title>
    <style>
...
<body>
    <div class="nav">
        <div>SRMS EHEALTH - Telestudio Doctors</div>
        <a href="view_analysis.php">Back to Analysis</a>
    </div>
    <div class="page">
        <div class="title">Telestudio Doctors</div>
        <div class="card">
            <table>
                <thead>
