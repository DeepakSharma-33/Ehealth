...
$nurse_name = htmlspecialchars(get_session_name() ?: 'Nursing Staff');
$nurse_id   = htmlspecialchars($_SESSION['nursing_id'] ?? '');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Nursing Staff Dashboard - eHealth</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nurse-pill { background: rgba(255,255,255,0.15); color: white; padding: 6px 14px; border-radius: 18px; font-size: 12px; font-weight: 600; }
        ...
        .card-icon { width: 70px; height: 70px; border-radius: 50%; background: linear-gradient(135deg, #2e7d32, #43a047); display: flex; align-items: center; justify-content: center; font-size: 30px; color: white; margin: 0 auto 16px; }
...
<nav class="navbar">
    ...
    <div class="nav-right">
        ...
        <div class="nurse-pill">ID: <?= $nurse_id ?></div>
...
<div class="hero">
    <h1>Welcome, <?= $nurse_name ?></h1>
    <p>Nursing Staff Dashboard</p>
</div>

<div class="dashboard">
    <div class="cards">
        <a href="nursing_vitals.php" class="card">
            <div class="card-icon">V</div>
            <h2>Vitals</h2>
            <p>Record patient vital signs and update the queue for doctor consultation.</p>
        </a>
