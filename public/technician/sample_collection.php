...
<head>
    ...
    <title>Sample Collection - Technician</title>
    <style>
...
<div class="wrap">
    <div class="title">
        ...
        <p>Welcome, <?= $tech_name ?>. Use this area to manage sample collection tasks.</p>
    </div>

    <div class="card">
        <h2>Module Ready</h2>
        <p>
            This page is set up for sample collection workflows. If you want patient lookup,
            test selection, barcode printing, or data saving, tell me the fields you need and I will build it.
        </p>
        <div class="actions">
