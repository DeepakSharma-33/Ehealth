...
$exec_name = htmlspecialchars(get_session_name());
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .exec-pill { display: flex; align-items: center; gap: 8px; background: rgba(255,255,255,0.15); border-radius: 20px; padding: 5px 14px 5px 8px; }
        .exec-pill-avatar { width: 26px; height: 26px; background: var(--green-light); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 13px; }
        .exec-pill-name { font-size: 13px; font-weight: 600; color: white; }
...
<nav class="navbar">
    ...
    <ul class="nav-links">
        <li><a href="/ehealth/public/executive/executive_dashboard.php">DASHBOARD</a></li>
    ...
    <div class="nav-right">
        <div class="exec-pill">
            <div class="exec-pill-avatar">👤</div>
            <span class="exec-pill-name"><?= $exec_name ?></span>
        </div>
...
<div class="save-success-overlay" id="saveSuccessOverlay">
    <div class="save-success-card">
        ...
        <a href="/ehealth/public/executive/executive_dashboard.php" class="save-success-btn">Back to Dashboard</a>
    </div>
</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-row-2">
                        <div>
                            <label style="font-size:13px;font-weight:600;color:var(--muted);display:block;margin-bottom:8px;">Executive Name</label>
                            <div class="readonly-field"><?= $exec_name ?></div>
                        </div>
                        <div>
                            <label style="font-size:13px;font-weight:600;color:var(--muted);display:block;margin-bottom:8px;">Executive ID</label>
                            <div class="readonly-field"><?= htmlspecialchars($exec_id) ?></div>
                        </div>
                    </div>
                    <div class="btn-row">
...
<script>
    ...
    async function searchPatient() {
        ...
        if (!pid) { showAlert('Please enter a Patient ID.', 'error'); return; }
